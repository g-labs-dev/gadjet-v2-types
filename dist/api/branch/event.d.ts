...
export declare type ADD_BODY = {
    event: Pick<Events, 'title' | 'content' | 'price' | 'openDate' | 'applyStartDate' | 'applyEndDate' | 'startDate' | 'endDate' | 'maxAttendeeCount' | 'place' | 'address' | 'addressDetail' | 'lat' | 'lng' | 'availableCreditType' | 'onlineFlag' | 'bannerImageId'>;
};
