declare module "gadjet-types" {
  ...
  type ManagerJoinType = "local" | "google";
  ...
  type ContractBillingSplitType =
    | "A" // 월 기준 분할
    | "B"; // 30일 기준 분할

  type ContractLateFeeType =
    | "none" // 연체료 부과 안함
    | "fix" // 고정금액
    | "rate"; // 이용료의 비율
